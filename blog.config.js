...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '2bea21950e8b477bb394918eb5d7308a',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yongbo', // 您的昵称 例如 Yongbo
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://33345.work', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Yongbo, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'YongboZhu@outlook.com', // 邮箱地址 例如 YongboZhu@outlook.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/YongboZhu', // 你的github个人主页 例如 https://github.com/YongboZhu
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/YongboZhu
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Yongbo BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
